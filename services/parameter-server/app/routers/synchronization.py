...
class SyncConfigRequest(BaseModel):
    ...
    staleness_weight_decay: float = Field(default=0.5, ge=0.0, le=1.0, description="Staleness decay")
...
async def submit_gradient_sync(
    request: GradientSubmitSyncRequest
) -> Dict[str, Any]:
    """
