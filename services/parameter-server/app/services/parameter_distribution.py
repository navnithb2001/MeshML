...
class ParameterDistributionService:
        ...
        if use_delta:
            ...
            if request.parameter_names:
                parameters = {
                    ...
                    if k in request.parameter_names
                }
    ...
    def _get_delta_parameters(
        ...
        changed_params = {
            ...
            if k in delta_info.changed_keys
        }
    ...
    def _convert_format(
        ...
        if target_format == ParameterFormat.PYTORCH:
            ...
            return {
                k: v.cpu().numpy() for k, v in parameters.items()
            }
