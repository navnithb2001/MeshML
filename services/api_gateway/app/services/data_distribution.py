...
class DataDistributor:
    ...
    def _assign_round_robin(
        ...
        assignments = {
            worker_id: WorkerAssignment(
                worker_id=worker_id,
                shard_id=-1  # Mixed shards
            )
    ...
    def _assign_load_balanced(
        ...
        for batch in sorted_batches:
            ...
            min_worker = min(
                worker_ids,
                key=lambda w: assignments[w].total_samples
            )
    ...
    def auto_reassign_failed_batches(
        self,
        ...
        for i, failed_assignment in enumerate(failed_batches):
            ...
            new_assignment = self.reassign_failed_batch(
                batch_id=failed_assignment.batch_id,
