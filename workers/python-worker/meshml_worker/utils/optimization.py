        ...
        try:
            ...
            if self.device_type == "cuda":
                ...
                return {
                    ...
                    "driver_allocated": torch.mps.driver_allocated_memory() if hasattr(torch.mps, "driver_allocated_memory") else 0
                }
            else:
...
class PerformanceBenchmark:
    ...
    def print_summary(self) -> None:
        ...
        has_data = len(stats) > 1 or (len(stats) == 1 and "total_samples" in stats and stats["total_samples"] > 0)
